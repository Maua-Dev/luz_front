...
const IFormInputsSchema = z.object({
  section: z
    .number()
    .min(0, { message: 'A largura tem que ser maior que 0' })
    .max(999, { message: 'A largura tem que ser menor que 1000' }),
  height: z
    .number()
    .min(0, { message: 'O comprimento tem que ser maior que 0' })
    .max(999, { message: 'O comprimenteo tem que ser menor que 1000' }),
